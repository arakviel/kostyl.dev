...
::note
Для використання `ConfigurationBuilder` потрібно встановити NuGet-пакети `Microsoft.Extensions.Configuration` та `Microsoft.Extensions.Configuration.Json` та `Microsoft.Extensions.Configuration.EnvironmentVariables`.
