...
::terminal-preview{title="dotnet sonarscanner" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet sonarscanner begin /k:"MyProject"</strong></div>
<div class="line"><span class="text-blue-400 font-bold">⚬</span> Scanner starting...</div>
<div class="line"></div>
<div class="line"><span class="opacity-40">$</span> <strong>dotnet build</strong></div>
<div class="line"><span class="text-green-400 font-bold">Build succeeded.</span></div>
<div class="line"></div>
<div class="line"><span class="opacity-40">$</span> <strong>dotnet sonarscanner end</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Analysis complete - results in SonarQube dashboard</div>
::
...
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed: 0, Passed: 42</div>
<div class="line">Coverage: 78.5%</div>
<div class="line"></div>
<div class="line"><span class="opacity-40">$</span> <strong>reportgenerator -reports:"coverage.xml" -targetdir:"coveragereport" -reporttypes:Html</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> HTML report generated: coveragereport/index.html</div>
::
