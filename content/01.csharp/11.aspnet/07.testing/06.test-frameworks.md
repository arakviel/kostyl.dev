...
<div class="line"><span class="opacity-40">$</span> <strong>dotnet test --logger "trx;LogFileName=results.trx"</strong></div>
<div class="line"></div>
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed:     0, Passed:    15, Skipped:     0</div>
<div class="line">Total tests: 15</div>
<div class="line">Passed in 2.34s</div>
::

::terminal-preview{title="dotnet test" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet test --logger "junit;LogFileName=results.xml"</strong></div>
<div class="line"></div>
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed:     0, Passed:    15, Skipped:     0</div>
<div class="line">Total tests: 15</div>
<div class="line">Passed in 2.34s</div>
...
::terminal-preview{title="dotnet test" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet test --logger "console;verbosity=detailed"</strong></div>
<div class="line"></div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> MyApp.Tests.CalculatorTests.Add_TwoNumbers_ReturnsSum [<span class="text-yellow-400">1ms</span>]</div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> MyApp.Tests.CalculatorTests.Divide_ByZero_ThrowsException [<span class="text-yellow-400">2ms</span>]</div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> MyApp.Tests.OrderServiceTests.CreateOrder_ValidData_Success [<span class="text-yellow-400">15ms</span>]</div>
::
...
::terminal-preview{title="dotnet add" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet add package FluentAssertions</strong></div>
<div class="line"><span class="text-green-400 font-bold">Successfully added</span> FluentAssertions (6.x) to MyProject.Tests.csproj</div>
::
...
<div class="line"><span class="opacity-40">$</span> <strong>dotnet new xunit -n MyProject.Tests</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Project created: MyProject.Tests.csproj</div>
<div class="line"></div>
<div class="line"><span class="opacity-40">$</span> <strong>dotnet add MyProject.Tests reference MyProject</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Reference added successfully</div>
<div class="line"></div>
<div class="line"><span class="opacity-40">$</span> <strong>dotnet add MyProject.Tests package FluentAssertions Moq AutoFixture.AutoFixture.Xunit2 Bogus</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Successfully added 5 packages</div>
::
...
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed: 0, Passed: 42, Skipped: 3</div>
<div class="line">Total tests: 45</div>
<div class="line">Passed in 3.21s</div>
::
...
<div class="line"></div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> OrderServiceTests.CreateOrder_ValidData_Success [12ms]</div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> OrderServiceTests.CreateOrder_NullItems_Throws [3ms]</div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> CalculatorTests.Add_TwoNumbers_ReturnsSum [1ms]</div>
<div class="line"><span class="text-blue-400 font-bold">✓</span> CalculatorTests.Divide_ByZero_Throws [2ms]</div>
<div class="line"></div>
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed: 0, Passed: 42, Skipped: 3</div>
::
...
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed: 0, Passed: 28, Skipped: 0</div>
<div class="line">Total tests: 28</div>
...
::terminal-preview{title="dotnet build && dotnet test --no-build" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet build --configuration Release</strong></div>
...
<div class="line"></div>
<div class="line"><span class="opacity-40">$</span> <strong>dotnet test --no-build</strong></div>
<div class="line"><span class="text-green-400 font-bold">Passed!</span> - Failed: 0, Passed: 42, Skipped: 3</div>
::
...
```plaintext [MyProject.sln]
Microsoft Visual Studio Solution File
```

```csharp [src/MyProject/MyProject.csproj]
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
...
```csharp [src/MyProject/Domain/Entities/Order.cs]
...
```csharp [src/MyProject/Application/Services/OrderService.cs]
...
```csharp [src/MyProject/Infrastructure/Repositories/OrderRepository.cs]
...
```csharp [tests/MyProject.Tests/MyProject.Tests.csproj]
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    <TargetFramework>net8.0</TargetFramework>
    <IsPackable>false</IsPackable>
...
```csharp [tests/MyProject.Tests/Unit/Domain/Entities/OrderTests.cs]
namespace MyProject.Tests.Unit.Domain.Entities;
public class OrderTests
{
    [Fact]
    public void Order_WithNegativeTotal_Throws()
    {
        Assert.Throws<ArgumentException>(() => new Order { Total = -10 });
    }
}
```

```csharp [tests/MyProject.Tests/Unit/Application/Services/OrderServiceTests.cs]
namespace MyProject.Tests.Unit.Application.Services;
public class OrderServiceTests
{
    [Fact]
...
```csharp [tests/MyProject.Tests/Integration/Repositories/OrderRepositoryTests.cs]
namespace MyProject.Tests.Integration.Repositories;
public class OrderRepositoryTests : IClassFixture<PostgreSqlFixture>
{
    [Fact]
...
```csharp [tests/MyProject.Tests/Shared/Builders/OrderBuilder.cs]
namespace MyProject.Tests.Shared.Builders;
