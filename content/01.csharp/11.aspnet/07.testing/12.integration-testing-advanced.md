...
│   └── Validators/
│       └── CreateOrderDtoValidatorTests.cs
│
├── Integration/
│   ├── Infrastructure/
│   │   ├── TestWebApplicationFactory.cs    ← спільна для всіх integration
│   │   ├── TestAuthHandler.cs
│   │   ├── PostgreSqlApiFixture.cs         ← для тестів з реальною БД
│   │   └── Extensions/
│   │       ├── HttpClientExtensions.cs     ← хелпери для запитів
│   │       └── ResponseExtensions.cs       ← хелпери для відповідей
│   │
│   ├── Endpoints/
...
│   │
│   └── Scenarios/
│       └── OrderLifecycleTests.cs           ← бізнес-сценарії
│
└── Helpers/
    ├── Builders/
    │   ├── OrderBuilder.cs
