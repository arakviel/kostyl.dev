...
<div class="line"><span class="opacity-40">$</span> <strong>dotnet add package Microsoft.Extensions.TimeProvider.Testing</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Successfully added Microsoft.Extensions.TimeProvider.Testing to MyApp.Tests.csproj</div>
::
...
::debugger-view{title="Debug: FakeTimeProvider" :variables='[{"name": "frozenTime", "type": "DateTimeOffset", "value": "2024-06-15 10:00:00 +00:00"}, {"name": "fakeTime", "type": "FakeTimeProvider", "value": "FakeTimeProvider with frozen clock"}, {"name": "service", "type": "JwtTokenService", "value": "JwtTokenService instance"}, {"name": "token", "type": "string", "value": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."}, {"name": "jwt", "type": "JsonWebToken", "value": "{ exp: 1718451600, iat: 1718450100 }"}]'}
::
...
::terminal-preview{title="dotnet add package" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet add package Verify.Xunit</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Successfully added Verify.Xunit to MyApp.Tests.csproj</div>
::
...
::terminal-preview{title="dotnet verify accept" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet verify accept</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Updated 15 snapshot files</div>
<div class="line"><span class="text-blue-400 font-bold">ℹ</span> Run tests again to verify</div>
::
...
::terminal-preview{title="dotnet add package FsCheck" :cursor="false"}
<div class="line"><span class="opacity-40">$</span> <strong>dotnet add package FsCheck FsCheck.Xunit</strong></div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Successfully added FsCheck to MyApp.Tests.csproj</div>
<div class="line"><span class="text-green-400 font-bold">✓</span> Successfully added FsCheck.Xunit to MyApp.Tests.csproj</div>
::
