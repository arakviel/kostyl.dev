...
```cshtml [Views/_ViewImports.cshtml]
@using ShopApp
...
```csharp [Services/SessionCartService.cs]
namespace ShopApp.Services;
...
```cshtml [Views/Shared/Components/ShoppingCart/Default.cshtml]
...
```csharp [Services/INotificationService.cs]
namespace ShopApp.Services;
...
```csharp [Services/StubNotificationService.cs]
namespace ShopApp.Services;
...
```cshtml [Views/Shared/Components/NotificationBell/Default.cshtml]
@using ShopApp.Services
...
```cshtml [Views/Shared/Components/Breadcrumb/Default.cshtml]
...
```cshtml [Views/Home/Index.cshtml]
@using ShopApp.ViewComponents
@{
...
```cshtml [Areas/Admin/Views/Shared/Components/AdminStats/Default.cshtml]
