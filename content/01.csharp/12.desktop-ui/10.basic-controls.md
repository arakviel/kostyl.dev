...
| URL зображення в Інтернеті | `Source="https://example.com/img.png"` | Онлайн-ресурси (асинхронне завантаження) |
...
<StackPanel Margin="20" Spacing="12">
  <TextBlock Text="Аватар користувача (зовнішній URL):"
             Foreground="Gray" FontSize="13"/>
  <Image Source="https://avatars.githubusercontent.com/u/14075148?s=200"
...
<StackPanel Margin="20" Spacing="8">
  ...
  <Border Width="160" Height="160" Background="#1A1A2E"
    ...
    <Image Source="https://picsum.photos/seed/wpf1/320/200"
           Stretch="None"/>
  </Border>
</StackPanel>
```
