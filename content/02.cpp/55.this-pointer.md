...
:::accordion-item{label="❌ Помилка 1: Спроба змінити this" icon="i-lucide-alert-triangle"}
...
:::accordion-item{label="❌ Помилка 2: Використання this у статичному методі" icon="i-lucide-alert-triangle"}
...
:::accordion-item{label="❌ Помилка 3: Повернення this замість *this для chaining" icon="i-lucide-alert-triangle"}
...
:::accordion-item{label="⚠️ Помилка 4: Видалення this" icon="i-lucide-alert-circle"}
...
:::accordion-item{label="📋 Умова задачі" icon="i-lucide-clipboard-list"}
