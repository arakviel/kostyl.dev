...
::card{title="Основні методи" icon="i-lucide-code"}
...
::card{title="Завантаження файлів" icon="i-lucide-file-up"}
...
::card{title="Критичні правила" icon="i-lucide-shield-alert"}
