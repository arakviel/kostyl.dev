...
- Не треба дизайнера
    ...
    ::collapsible{title="Продуктова компанія з брендом"}
...
- Легко підтримувати
    ...
    ::collapsible{title="Enterprise додаток"}
...
- Велика спільнота
    ...
    ::collapsible{title="Розробник-ентузіаст / Pet Project"}
