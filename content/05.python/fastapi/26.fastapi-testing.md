...
# Додає поточну директорію до шляхів пошуку модулів Python
pythonpath = ["."]
        ...
        steps:
            ...
            - name: Install dependencies
              run: |
                  ...
                  pip install ruff mypy pytest pytest-asyncio pytest-cov pytest-mock httpx faker factory-boy sqlalchemy asyncpg pydantic python-multipart
