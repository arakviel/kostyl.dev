...
::tabs
::tabs-item{label="Прості (атомарні)"}
...
::warning{title="Часто зустрічувані помилки"}
Навіть досвідчені розробники допускають їх!
::

### 1. Плутанина: Сутність чи Атрибут?
...
> Інтернет-магазин продає товари. Кожен товар належить до певної категорії. Клієнти реєструються в системі та роблять замовлення. Одне замовлення може містити кілька товарів. Кожне замовлення має статус (нове, оплачене, відправлене, доставлене).
