...
::note
**Детальніше про індекси**: Для повного розуміння індексів, їх типів (CLUSTERED, NONCLUSTERED), стратегій оптимізації та best practices дивіться окрему тему: [Індекси в MS SQL Server](../02.ms-sql-server-start/02.indexes.md)
::
