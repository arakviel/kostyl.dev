...
graph TD
    ...
    A["C# Source Code"] --> B["C# Compiler (Roslyn)"]
...
```text
HelloDotNet/
├── Program.cs          # Головний файл з кодом
├── HelloDotNet.csproj  # Файл конфігурації проєкту
└── obj/                # Тимчасові файли компіляції
```

![Структура .NET проєкту в VS Code з відкритими файлами Program.cs та .csproj](/images/csharp/fundamentals/introduction-to-ecosystem/dotnet-project-structure-vscode.png){.screenshot-img}

<!-- Search Query: VS Code .NET console project structure screenshot explorer -->
