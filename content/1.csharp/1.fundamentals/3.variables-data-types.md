...
graph TD
    ...
    style Stack fill:#1a237e,stroke:#5c6bc0,stroke-width:3px,color:#fff
    style Heap fill:#e65100,stroke:#ff9800,stroke-width:3px,color:#fff
    style V1 fill:#1b5e20,stroke:#66bb6a,stroke-width:2px,color:#fff
    style V2 fill:#1b5e20,stroke:#66bb6a,stroke-width:2px,color:#fff
    style R1 fill:#0d47a1,stroke:#42a5f5,stroke-width:2px,color:#fff
    style R2 fill:#0d47a1,stroke:#42a5f5,stroke-width:2px,color:#fff
    style O1 fill:#e65100,stroke:#ffb74d,stroke-width:2px,color:#fff
```
