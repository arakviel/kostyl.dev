...
:::tab{label="Verbatim Strings"}
Verbatim-рядки (дослівні рядки) з префіксом `@` — не потребують екранування:
...
:::tab{label="Raw String Literals"}
Raw string literals (C# 11+) з потрійними лапками `"""` — найпотужніший спосіб:
