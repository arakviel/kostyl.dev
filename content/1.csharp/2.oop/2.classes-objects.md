...
classDiagram
    ...
    class Object1["account1\n(Object)"] {
        accountNumber = "001"
        owner = "Іван"
        balance = 1000
    }

    class Object2["account2\n(Object)"] {
        accountNumber = "002"
        owner = "Марія"
        balance = 2500
    }
...
sequenceDiagram
    ...
    style Heap fill:#64748b,stroke:#334155,color:#ffffff
    style Obj fill:#f59e0b,stroke:#b45309,color:#ffffff
```
...
**Primary Constructors** — це синтаксичний цукор, введений у C# 12, який дозволяє визначати параметри конструктора безпосередньо в оголошенні класу.
...
Ключове слово `this` представляє посилання на **поточний екземпляр** класу. Використовується для:
...
Обмежує видимість типу до **одного файлу**.
