...
::note
**Інкапсуляція (Encapsulation)** — один з фундаментальних принципів ООП, який передбачає приховування внутрішньої реалізації об'єкта та надання контрольованого доступу до його стану через публічний інтерфейс.
::
...
::note
**Record types** в C# 9+ автоматично використовують `init` accessors для створення незмінних об'єктів з concise syntax.
::
...
sequenceDiagram
    ...
    style Prop fill:#f59e0b,stroke:#b45309,color:#ffffff
    style Field fill:#64748b,stroke:#334155,color:#ffffff
```
