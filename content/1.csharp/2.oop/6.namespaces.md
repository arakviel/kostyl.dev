...
Кожен тип у C# має **повне ім'я** (Fully Qualified Name), яке включає namespace:
...
У C# існує два способи оголошення namespace: **block-scoped** (традиційний) та **file-scoped** (сучасний, C# 10+).
