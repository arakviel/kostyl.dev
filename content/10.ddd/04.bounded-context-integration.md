...
::accordion
::accordion-item{label="Сценарій 1: Вартість дублювання > Вартість координації"}
...
::accordion-item{label="Сценарій 3: Поступова модернізація Legacy"}
...
::accordion-item{label="Сценарій 4: Проблеми з комунікацією"}
...
::accordion
::accordion-item{label="Сценарій 1: Core Subdomain"}
...
::accordion-item{label="Сценарій 2: Неефективна модель Upstream"}
...
::accordion-item{label="Сценарій 3: Часті зміни Upstream"}
...
::accordion
::accordion-item{label="Проблеми комунікації"}
...
::accordion-item{label="Generic Subdomain"}
...
::accordion-item{label="Несумісні моделі"}
...
::accordion
::accordion-item{label=" як вибрати правильний паттерн?"}
