...
::accordion
::accordion-item{label="Чи можна використовувати HTTP для комунікації між сервісами?"}
...
::
::accordion-item{label="Де зберігати стан Саги?"}
...
::
::accordion-item{label="Що робити, якщо подія прийшла раніше, ніж ми її очікували?"}
...
::accordion-item{label="Чи потрібен Outbox, якщо я використовую Kafka Connect?"}
