...
```jsonc [.vscode/settings.json]
{
    ...
    "stylelint.config": {
        ...
        "rules": {
            // Регулярний вираз для класичного BEM (kebab-case): block-name__element-name--modifier-name
            "selector-class-pattern": [
                "^[a-z0-9]+(-[a-z0-9]+)*(__[a-z0-9]+(-[a-z0-9]+)*)?(--[a-z0-9]+(-[a-z0-9]+)*)?$",
                {
                    "resolveNestedSelectors": true,
                    "message": "Назва класу не відповідає конвенції BEM (block__element--modifier у kebab-case)",
                },
            ],
        },
    },
