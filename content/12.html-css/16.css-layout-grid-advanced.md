...
_Попередня стаття: [CSS Grid. Частина 1 — Основи, fr, repeat, minmax, розміщення](/12.html-css/14.css-layout-grid)_

_Наступна стаття: [Позиціонування в CSS. Z-index. Stacking Context](/12.html-css/15.css-positioning)_
