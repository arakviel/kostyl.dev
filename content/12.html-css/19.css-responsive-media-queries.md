...
_Попередня стаття: [CSS Анімації та Переходи](/html-css/css-animations-transitions)_

_Продовження: [Адаптивний дизайн. Частина 2 — clamp(), Container Queries, @layer](/html-css/css-responsive-advanced)_
