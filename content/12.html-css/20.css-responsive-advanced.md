...
_Попередня стаття: [Адаптивний дизайн. Частина 1 — Media Queries, Mobile-First](/12.html-css/16.css-responsive-media-queries)_

_Наступна стаття: [CSS Анімації та Переходи](/12.html-css/17.css-animations-transitions)_
