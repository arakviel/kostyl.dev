...
_Попередня стаття: [CSS Анімації та Переходи](/12.html-css/17.css-animations-transitions)_

_Наступна стаття: [CSS Pseudo-classes та Pseudo-elements](/12.html-css/19.css-pseudo-elements)_
