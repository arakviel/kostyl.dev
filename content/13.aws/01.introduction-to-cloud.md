...
```powershell [Windows]
# На Windows права доступу зазвичай не потребують ручного налаштування.
# Якщо ви використовуєте PowerShell, просто підключіться:
ssh -i "$env:USERPROFILE\Downloads\my-aws-key.pem" ec2-user@<PUBLIC_IP>
```
