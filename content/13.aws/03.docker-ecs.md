...
4. **Task roles:**
    - Task role: _залиште пустим_ (наш API не звертається до інших AWS сервісів)
    - Task execution role: `ecsTaskExecutionRole`
5. **Container — 1:**
    - Name: `ecs-lab-api`
    - Image URI: `ВАШ_ACCOUNT_ID.dkr.ecr.eu-central-1.amazonaws.com/ecs-lab-api:v1.0.0`
      _(скопіюйте URI з ECR → Repositories → ecs-lab-api → Images → тег v1.0.0)_
...
| **Type**         | CNAME                                                                  |
| **Name/Host**    | `myecs`                                                                |
| **Value/Target** | `ecs-lab-alb-123456789.eu-central-1.elb.amazonaws.com` _(ваш ALB DNS)_ |
| **TTL**          | 300                                                                    |
