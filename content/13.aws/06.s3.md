...
![Amazon S3 versioning enabled overview screenshot](/images/aws/s3/01.png){.diagram-img}

![Amazon S3 versioning put operation screenshot](/images/aws/s3/02.png){.diagram-img}

![Amazon S3 versioning delete marker screenshot](/images/aws/s3/03.png){.diagram-img}
...
![Amazon S3 Block Public Access settings screenshot](/images/aws/s3/04.png){.diagram-img}
...
![Amazon S3 static website delivery through CloudFront diagram](/images/aws/s3/05.png){.diagram-img}
...
![AWS CloudFront S3 video streaming architecture diagram](/images/aws/s3/06.png){.diagram-img}
...
![Amazon S3 console objects deployment screenshot](/images/aws/s3/07.gif){.diagram-img}
