...
![HTML → компоненти React Native](/images/react-native/core-components/01.svg){.diagram-img}
...
![Вкладеність View](/images/react-native/core-components/02.svg){.diagram-img}
...
![Pressable: rest / pressed / onPress](/images/react-native/core-components/03.svg){.diagram-img}

За [документацією Pressable](https://reactnative.dev/docs/pressable): обгортка, що відстежує **стадії** press на будь-якому вкладеному вмісті.
...
![ScrollView і bounded height](/images/react-native/core-components/04.svg){.diagram-img}
...
| | ScrollView | FlatList |
| - | ---------- | -------- |
| Рендер вмісту | **Усі одразу** | **Ліниво** (майже видимі) |
