...
У [Nomad](https://github.com/arakviel/nomad) переносимо ідею «картки» на домен подорожей: кілька **фіктивних** поїздок, компонент картки, прокручуваний домашній екран. Нижче — **покроково файли й код**; живе прев’ю — **в кінці** розділу, після коміту.
...
```bash
cd /path/to/kostyl.dev/[Nomad](https://github.com/arakviel/nomad)
npx expo start
```
...
У клоні [https://github.com/arakviel/nomad](https://github.com/arakviel/nomad) (**один** коміт на цю статтю):
