...
Семантичні палітри light/dark (повний файл у репозиторії `projects/nomad`).
...
1. `npx expo start` у `projects/nomad`.  
...
```bash
git add projects/nomad content/15.react-native/08.stylesheet-and-theming.md content/15.react-native/index.md
