...
![Ланцюжок Node → Expo → Metro → пристрій](/images/react-native/expo-setup-and-tooling/01.svg){.diagram-img}
...
![Каркас після create-expo-app](/images/react-native/expo-setup-and-tooling/03.svg){.diagram-img}
...
![Цикл розробки з Metro](/images/react-native/expo-setup-and-tooling/02.svg){.diagram-img}
...
- Репозиторій [Nomad](https://github.com/arakviel/nomad): Expo + TypeScript.
...
::tip
**Готовий код 1:1** з [Nomad](https://github.com/arakviel/nomad) на момент init. Найшвидше: `git clone` / `git pull`. Нижче — **весь** проєкт (усі файли з кодом) після init, не «схема папок без вмісту».
::
