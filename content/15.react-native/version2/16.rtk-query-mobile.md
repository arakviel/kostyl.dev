...
description: Повний практичний посібник з RTK Query у React Native — налаштування createApi, JWT Refresh Token Mutex Queue, query/mutation ендпоінти, гранулярна інвалідація через теги, refetch при зміні фокусу та мережі, optimistic updates, selectFromResult, WebSockets, безкінечна пагінація та міграція проєкту Nomad.
---
...
### Структура та налаштування `createApi`
...
### Що повертає Query-хук: повний розбір результату
