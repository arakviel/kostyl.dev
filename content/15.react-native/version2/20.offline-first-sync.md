...
| **CRDT (Conflict-Free Replicated Data Types)** | Автоматичне об'єднання змін без конфліктів | Немає ручного merge, працює P2P | Складний, не всі типи даних підтримує | Collaborative editing (Figma, Google Docs), chat |
