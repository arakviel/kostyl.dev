...
::card{title="🏠 Фактори ціни нерухомості" icon="i-lucide-home"}

- **Площа** (м²) — головний фактор
- **Кількість кімнат** — функціональність
- **Поверх** — престижність (середні поверхи дорожчі)
- **Відстань до метро** (км) — логістика
- **Район** — інфраструктура, безпека
- **Рік побудови** — стан будинку
- **Наявність балкона** (так/ні)
- **Стан ремонту** (бали від 1 до 5)
...
#output
![Feature Importance](/images/ai-python/linear-regression-theory/feature-importance.png){.diagram-img}
::
