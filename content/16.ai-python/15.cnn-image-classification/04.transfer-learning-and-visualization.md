...
ResNet(
  ...
  (layer1): Sequential(...)  # 2 блоки residual
  (layer2): Sequential(...)  # 2 блоки residual
  (layer3): Sequential(...)  # 2 блоки residual
  (layer4): Sequential(...)  # 2 блоки residual
...
Останній шар (FC): Linear(in_features=512, out_features=1000, bias=True)
Параметрів у FC шарі: 513,000
Параметрів у згорткових шарах: 11,176,512
```
...
Тренувальних батчів: 782
Тестових батчів: 157
Розмір зображення після трансформацій: torch.Size([3, 224, 224])
```
...
======================================================================
Загальна кількість параметрів: 11,689,512
Навчаємих параметрів (FC шар): 5,130
Заморожених параметрів (згорткові шари): 11,684,382
Відсоток навчаємих параметрів: 0.04%
======================================================================
```

**Спостереження:** Ми навчаємо лише **0.04%** параметрів моделі! 99.96% ваг залишаються незмінними.
...
Епоха [1/10] Train Loss: 0.4523 | Train Acc: 84.12% | Val Loss: 0.3845 | Val Acc: 86.45%
Епоха [2/10] Train Loss: 0.3234 | Train Acc: 88.67% | Val Loss: 0.3123 | Val Acc: 88.92%
Епоха [3/10] Train Loss: 0.2845 | Train Acc: 89.98% | Val Loss: 0.2934 | Val Acc: 89.67%
Епоха [4/10] Train Loss: 0.2612 | Train Acc: 90.87% | Val Loss: 0.2823 | Val Acc: 90.12%
Епоха [5/10] Train Loss: 0.2456 | Train Acc: 91.34% | Val Loss: 0.2745 | Val Acc: 90.45%
Епоха [6/10] Train Loss: 0.2134 | Train Acc: 92.45% | Val Loss: 0.2623 | Val Acc: 90.78%
Епоха [7/10] Train Loss: 0.2045 | Train Acc: 92.89% | Val Loss: 0.2598 | Val Acc: 90.89%
Епоха [8/10] Train Loss: 0.1989 | Train Acc: 93.12% | Val Loss: 0.2589 | Val Acc: 91.02%
Епоха [9/10] Train Loss: 0.1956 | Train Acc: 93.28% | Val Loss: 0.2578 | Val Acc: 91.12%
Епоха [10/10] Train Loss: 0.1934 | Train Acc: 93.45% | Val Loss: 0.2571 | Val Acc: 91.18%

✅ Навчання завершено! Фінальна Val Accuracy: 91.18%
🚀 Порівняйте: з нуля за 30 епох → 81%, Transfer Learning за 10 епох → 91.18%
```

**Час навчання:** ~4-5 хвилин на GPU (швидше, ніж навчання з нуля!)
