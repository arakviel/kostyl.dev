...
rectangle Const #FCA5A5 [
<b>const numbers = [1, 2, 3]</b>
--
...
rectangle Readonly #86EFAC [
<b>readonly numbers = [1, 2, 3]</b>
--
...
rectangle Both #BFDBFE [
<b>const numbers: readonly number[]</b>
--
...
card Fixed #DCFCE7 [
<b>Фіксована структура</b>
(знаємо всі властивості)
--
<b>Використовуйте явну типізацію:</b>
...
card Dynamic #DBEAFE [
<b>Динамічна структура</b>
(ключі невідомі)
--
<b>Використовуйте index signature:</b>
...
card Hybrid #FEF3C7 [
<b>Комбінований підхід</b>
(часткова фіксованість)
--
<b>Комбінуйте обидва:</b>
{
  required: string;
  [key: string]: string;
}
