...
const data: string = fs.readFileSync(path.join(__dirname, 'config.json'), 'utf8');
...
fs.readFile('large-file.txt', 'utf8', (err: NodeJS.ErrnoException | null, data: string) => {
  if (err) {
