...
rectangle M1 #DCFCE7 [
<b>Механізм 1: @Redirect статичний</b>
--
Статичний URL і код
--
@Get('old')
...
rectangle M2 #DBEAFE [
<b>Механізм 2: Динамічне повернення</b>
--
URL і код з логіки
--
@Get(':code')
...
rectangle M3 #FED7AA [
<b>Механізм 3: @Res().redirect()</b>
--
Прямий виклик Express
--
@Get('old')
handler(@Res() res) {
...
rectangle SIMPLE #E2E8F0 [
Читабельність +++
--
Гнучкість -
]

rectangle BALANCED #E2E8F0 [
Читабельність ++
--
Гнучкість +++
]

rectangle COMPLEX #E2E8F0 [
Читабельність +
--
Гнучкість ++
]

M1 --> SIMPLE : Найпростіший
M2 --> BALANCED : Рекомендований
M3 --> COMPLEX : Складний
