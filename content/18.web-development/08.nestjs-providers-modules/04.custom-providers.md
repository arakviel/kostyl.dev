...
if (Чи є це клас з @Injectable?) then (так)
  if (Токен співпадає з класом?) then (так)
    #DCFCE7:Використовуйте<br/><b>shorthand</b>;
  else (ні)
    #E0E7FF:Використовуйте<br/><b>useClass</b>;
  endif
else (ні)
  if (Чи потрібна динамічна логіка<br/>або залежності?) then (так)
    #C7D2FE:Використовуйте<br/><b>useFactory</b>;
  else (ні)
    if (Це псевдонім для<br/>існуючого провайдера?) then (так)
      #DBEAFE:Використовуйте<br/><b>useExisting</b>;
    else (ні)
      #BBF7D0:Використовуйте<br/><b>useValue</b>;
    endif
  endif
endif
