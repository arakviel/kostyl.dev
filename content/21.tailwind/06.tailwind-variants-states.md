...
Живий приклад `has-*`, `group` та `peer` у дії:
...
<body class="p-6 bg-slate-50" style="font-family: system-ui, sans-serif;">

<div class="space-y-5 max-w-md mx-auto">
    <p class="text-xs font-bold uppercase tracking-widest text-slate-400 text-center mb-6">
        has-* / group / peer — живий демо
    </p>

    <!-- has-[:focus]: Label підсвічується при фокусі input -->
    <div class="bg-white rounded-xl p-4 border border-slate-200">
        <p class="text-xs text-slate-500 mb-3 font-semibold">has-[:focus]: — label реагує на focus вкладеного input</p>
        <label class="block text-sm font-semibold text-slate-600
                      has-[:focus]:text-indigo-600 transition-colors cursor-pointer">
            Email адреса
            <input type="email" placeholder="name@example.com"
                   class="mt-1.5 block w-full px-3 py-2
    ...
    <!-- group-hover: hover на батьку змінює дочірній -->
    <div class="bg-white rounded-xl p-4 border border-slate-200">
        <p class="text-xs text-slate-500 mb-3 font-semibold">group-hover: — наведіть на картку</p>
        <div class="group flex items-center gap-3 p-3 rounded-lg
                    hover:bg-indigo-50 transition-colors cursor-pointer border border-slate-200">
            <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-xl flex-shrink-0">
                👤
            </div>
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-slate-400 group-hover:text-indigo-500 transition-colors">
                    Frontend Developer
                </p>
            </div>
            <!-- Іконка прихована, з'являється при hover -->
            <svg class="w-4 h-4 text-slate-300 group-hover:text-indigo-500 opacity-0 group-hover:opacity-100 transition-all"
    ...
    <div class="bg-white rounded-xl p-4 border border-slate-200">
        <p class="text-xs text-slate-500 mb-3 font-semibold">peer-checked: — toggle switch без JavaScript</p>
        <div class="flex items-center justify-between">
            <span class="text-sm text-slate-700 font-medium">Темна тема</span>
