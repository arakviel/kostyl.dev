...
## [Зчитування з document.cookie](https://uk.javascript.info/cookie#zchituvannya-z-document-cookie)
...
## [Запис в document.cookie](https://uk.javascript.info/cookie#zapis-v-document-cookie)

Ми можемо записувати в `document.cookie`. Але це не просто властивості даних, це [аксесори (гетери/сетери)](https://uk.javascript.info/property-accessors). Присвоєння цих властивостей обробляється особливим чином.
...
## [domain](https://uk.javascript.info/cookie#domain)
...
## [path](https://uk.javascript.info/cookie#path)
...
## [expires, max-age](https://uk.javascript.info/cookie#expires-max-age)
...
## [secure](https://uk.javascript.info/cookie#secure)
...
## [samesite](https://uk.javascript.info/cookie#samesite)
...
### [XSRF-атаки](https://uk.javascript.info/cookie#xsrf-ataki)
...
### [Використання атрибуту samesite в файлі cookie](https://uk.javascript.info/cookie#vikoristannya-atributu-samesite-v-faili-cookie)
...
## [httpOnly](https://uk.javascript.info/cookie#httponly)
...
## [Додаток: Функції файлів cookie](https://uk.javascript.info/cookie#dodatok-funkciyi-failiv-cookie)
...
### [getCookie(name)](https://uk.javascript.info/cookie#getcookie-name)

Найкоротший шлях щоб отримати доступ до файлів cookie це використання [регулярних виразів](https://uk.javascript.info/regular-expressions).
...
### [setCookie(name, value, attributes)](https://uk.javascript.info/cookie#setcookie-name-value-attributes)
...
### [deleteCookie(name)](https://uk.javascript.info/cookie#deletecookie-name)
...
Все разом: [cookie.js](https://uk.javascript.info/article/cookie/cookie.js).

## [Додаток: Сторонні файли cookies](https://uk.javascript.info/cookie#dodatok-storonni-faili-cookies)
...
## [Додаток: GDPR](https://uk.javascript.info/cookie#dodatok-gdpr)
...
## [Підсумки](https://uk.javascript.info/cookie#pidsumki)
