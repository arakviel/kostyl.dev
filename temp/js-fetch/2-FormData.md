...
## [Надсилання простої форми](https://uk.javascript.info/formdata#nadsilannya-prostoyi-formi)
...
## [Методи об’єкта FormData](https://uk.javascript.info/formdata#metodi-obyekta-formdata)
...
-   `formData.a ppend(name, blob, fileName)` – додає поле так, ніби це `<input type="file">`, третій аргумент `fileName` встановлює ім’я файлу (не ім’я поля форми), ніби це ім’я з файлової системи користувача,
...
## [Надсилання форми з файлом](https://uk.javascript.info/formdata#nadsilannya-formi-z-failom)
...
## [Надсилання форми з даними Blob](https://uk.javascript.info/formdata#nadsilannya-formi-z-danimi-blob)

Раніше у главі [Fetch](https://uk.javascript.info/fetch) ми бачили, що дуже легко відправити динамічно згенеровані бінарні дані у форматі `Blob`. Ми можемо явно передати їх до параметра `body` запиту `fetch`.
...
## [Підсумки](https://uk.javascript.info/formdata#pidsumki)
