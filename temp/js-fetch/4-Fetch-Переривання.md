...
## [Об’єкт AbortController](https://uk.javascript.info/fetch-abort#obyekt-abortcontroller)
...
## [Використання з fetch](https://uk.javascript.info/fetch-abort#vikoristannya-z-fetch)
...
## [AbortController є масштабованим](https://uk.javascript.info/fetch-abort#abortcontroller-ye-masshtabovanim)
...
## [Підсумки](https://uk.javascript.info/fetch-abort#pidsumki)
