...
Основною концепцією тут є _джерело_ (_origin_) – триплет домен/порт/протокол.
...
## [Навіщо потрібен CORS? Коротка історія](https://uk.javascript.info/fetch-crossorigin#navisho-potriben-cors-korotka-istoriya)
...
### [Використання форм](https://uk.javascript.info/fetch-crossorigin#vikoristannya-form)
...
### [Використання скриптів](https://uk.javascript.info/fetch-crossorigin#vikoristannya-skriptiv)
...
## [Безпечні запити](https://uk.javascript.info/fetch-crossorigin#bezpechni-zapiti)
...
## [CORS для безпечних запитів](https://uk.javascript.info/fetch-crossorigin#cors-dlya-bezpechnikh-zapitiv)
...
## [Заголовки відповіді](https://uk.javascript.info/fetch-crossorigin#zagolovki-vidpovidi)
...
## [“Небезпечні” запити](https://uk.javascript.info/fetch-crossorigin#nebezpechni-zapiti)
...
### [Крок 1 (попередній(preflight) запит)](https://uk.javascript.info/fetch-crossorigin#krok-1-poperednii-preflight-zapit)
...
### [Крок 2 (попередня відповідь)](https://uk.javascript.info/fetch-crossorigin#krok-2-poperednya-vidpovid)
...
### [Крок 3 (фактичний запит)](https://uk.javascript.info/fetch-crossorigin#krok-3-faktichnii-zapit)
...
### [Крок 4 (фактична відповідь)](https://uk.javascript.info/fetch-crossorigin#krok-4-faktichna-vidpovid)
...
## [Облікові дані](https://uk.javascript.info/fetch-crossorigin#oblikovi-dani)
...
Якщо сервер погоджується прийняти запит _з обліковими даними_, він має додати до відповіді заголовок `Access-Control-Allow-Credentials: true` на додаток до `Access-Control-Allow-Origin`.
...
## [Підсумки](https://uk.javascript.info/fetch-crossorigin#pidsumki)
