...
## [Створення URL](https://uk.javascript.info/url#stvorennya-url)
...
## [Параметри пошуку “?…”](https://uk.javascript.info/url#parametri-poshuku)
...
## [Кодування](https://uk.javascript.info/url#koduvannya)
...
### [Кодування рядків](https://uk.javascript.info/url#koduvannya-ryadkiv)
...
-   [encodeURI](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/encodeURI) – закодувати URL-адресу повністю.
-   [decodeURI](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/decodeURI) – розкодувати її.
-   [encodeURIComponent](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent) – закодувати частину URL-адреси, наприклад, параметри пошуку, шлях чи хеш.
-   [decodeURIComponent](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/decodeURIComponent) – розкодувати відповідну частину.
