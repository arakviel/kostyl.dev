...
Щось з цього звучить знайомо? Якщо так, то продовжуйте знайомство з `XMLHttpRequest`. В іншому випадку можливо є сенс одразу перейти до [Fetch](https://uk.javascript.info/fetch).

## [Основи](https://uk.javascript.info/xmlhttprequest#osnovi)
...
2.  Ініціалізувати його, зазвичай це роблять відразу після `new XMLHttpRequest`:
    ...
    -   `URL` – URL для запиту, зазвичай це рядок, але може бути і об’єктом [URL](https://uk.javascript.info/url).
...
Щоб додати параметри до URL-адреси, наприклад `?name=value`, і забезпечити належне кодування, ми можемо використовувати об’єкт [URL](https://uk.javascript.info/url):
...
## [Тип відповіді](https://uk.javascript.info/xmlhttprequest#tip-vidpovidi)
...
-   `"arraybuffer"` – отримати як `ArrayBuffer` (для двійкових даних див. розділ [ArrayBuffer, бінарні масиви](https://uk.javascript.info/arraybuffer-binary-arrays)),
-   `"blob"` – отримати як `Blob` (для двійкових даних див. розділ [Blob](https://uk.javascript.info/blob)),
...
## [Стани запиту](https://uk.javascript.info/xmlhttprequest#stani-zapitu)
...
## [Скасування запиту](https://uk.javascript.info/xmlhttprequest#skasuvannya-zapitu)
...
## [Синхронні запити](https://uk.javascript.info/xmlhttprequest#sinkhronni-zapiti)
...
## [HTTP-заголовки](https://uk.javascript.info/xmlhttprequest#http-zagolovki)
...
Декількома заголовками керує виключно браузер, наприклад `Referer` і `Host`. Повний їх список є [у специфікації](https://xhr.spec.whatwg.org/#the-setrequestheader()-method).
...
## [POST, FormData](https://uk.javascript.info/xmlhttprequest#post-formdata)

Щоб зробити запит POST, ми можемо використати вбудований об’єкт [FormData](https://developer.mozilla.org/uk/docs/Web/API/FormData).
...
## [Хід завантаження](https://uk.javascript.info/xmlhttprequest#khid-zavantazhennya)
...
## [Запити на інші джерела](https://uk.javascript.info/xmlhttprequest#zapiti-na-inshi-dzherela)

`XMLHttpRequest` може робити запити інші джерела (сайти) використовуючи ту саму політику CORS, що й [fetch](https://uk.javascript.info/fetch-crossorigin).
...
Дивіться розділ [Fetch: Запити між різними джерелами](https://uk.javascript.info/fetch-crossorigin), щоб дізнатися більше про заголовки які використовуються для запитів на інші джерела.

## [Підсумки](https://uk.javascript.info/xmlhttprequest#pidsumki)
