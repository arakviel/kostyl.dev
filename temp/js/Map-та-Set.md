...
## [Map](https://uk.javascript.info/map-set#map)
...
## [Перебір Map](https://uk.javascript.info/map-set#perebir-map)
...
## [Object.entries: Map з Object](https://uk.javascript.info/map-set#object-entries-map-z-object)
...
## [Object.fromEntries: Object з Map](https://uk.javascript.info/map-set#object-fromentries-object-z-map)
...
## [Set](https://uk.javascript.info/map-set#set)
...
## [Перебір об’єкта Set](https://uk.javascript.info/map-set#perebir-obyekta-set)
...
Зауважимо цікаву річ. Функція в `forEach` у `Set` має 3 аргументи: значення ‘value’, потім знову _те саме значення_ ‘valueAgain’, і тільки потім цільовий об’єкт. Це дійсно так, значення з’являється в списку аргументів двічі.
...
## [Підсумки](https://uk.javascript.info/map-set#pidsumki)
