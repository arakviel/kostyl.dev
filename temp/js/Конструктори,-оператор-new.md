...
## [Функція-конструктор](https://uk.javascript.info/constructor-new#funkciya-konstruktor)
...
## [Перевірка виклику у режимі конструктора: new.target](https://uk.javascript.info/constructor-new#perevirka-vikliku-u-rezhimi-konstruktora-new-target)
...
## [Повернення значення з конструктора return](https://uk.javascript.info/constructor-new#povernennya-znachennya-z-konstruktora-return)
...
## [Створення методів у конструкторі](https://uk.javascript.info/constructor-new#stvorennya-metodiv-u-konstruktori)
...
Для створення складних об’єктів існує більш просунутий синтаксис, [класи](https://uk.javascript.info/classes), про який ми поговоримо пізніше.

## [Підсумки](https://uk.javascript.info/constructor-new#pidsumki)
...
Після того, як ми це вивчимо, ми повернемося до об’єктів для більш детального їх вивчення у розділах [Прототипи, наслідування](https://uk.javascript.info/prototypes) та [Класи](https://uk.javascript.info/classes).