...
## [Додавання/видалення елементів](https://uk.javascript.info/array-methods#dodavannya-vidalennya-elementiv)
...
### [splice](https://uk.javascript.info/array-methods#splice)
...
Метод [arr.splice](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/splice) – це універсальний «швейцарський ніж» для роботи з масивами. Вміє все: додавати, видаляти і замінювати елементи.
...
### [slice](https://uk.javascript.info/array-methods#slice)

Метод [arr.slice](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/slice) набагато простіший, ніж схожий на нього `arr.splice`.
...
### [concat](https://uk.javascript.info/array-methods#concat)

Метод [arr.concat](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/concat) створює новий масив, в який копіює дані з інших масивів та додаткові значення.
...
## [Перебір: forEach](https://uk.javascript.info/array-methods#perebir-foreach)

Метод [arr.forEach](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach) дозволяє запускати функцію для кожного елемента масиву…
...
## [Пошук в масиві](https://uk.javascript.info/array-methods#poshuk-v-masivi)

Далі розглянемо методи, які допоможуть знайти що-небудь в масиві.

### [indexOf/lastIndexOf та includes](https://uk.javascript.info/array-methods#indexof-lastindexof-ta-includes)

Методи [arr.indexOf](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf) та [arr.includes](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/includes) мають однаковий синтаксис і роблять по суті те ж саме, що і їх рядкові аналоги, але працюють з елементами замість символів:
...
Метод [arr.lastIndexOf](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/lastIndexOf) такий самий, як `indexOf`, але шукає справа наліво.
...
### [find і findIndex/findLastIndex](https://uk.javascript.info/array-methods#find-i-findindex-findlastindex)

Уявіть, що у нас є масив обʼєктів. Як нам знайти обʼєкт за певною умовою?

Тут стане в нагоді метод [arr.find(fn)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/find).
...
Метод [arr.findIndex](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/findIndex) – по суті, те ж саме, але повертає індекс, на якому був знайдений елемент, а не сам елемент, і `-1`, якщо нічого не знайдено.

Метод [arr.findLastIndex](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/findLastIndex) схожий на `findIndex`, але шукає справа наліво, подібно до `lastIndexOf`.
...
### [filter](https://uk.javascript.info/array-methods#filter)

Метод `find` шукає один (перший) елемент, на якому функція-колбек поверне `true`.

На той випадок, якщо знайдених елементів може бути багато, передбачений метод [arr.filter(fn)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/filter).
...
## [Перетворення масиву](https://uk.javascript.info/array-methods#peretvorennya-masivu)

Перейдемо до методів перетворення і впорядкування масиву.

### [map](https://uk.javascript.info/array-methods#map)

Метод [arr.map](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/map) є одним з найбільш корисних і часто використовуваних.
...
### [sort(fn)](https://uk.javascript.info/array-methods#sort-fn)

Виклик [arr.sort()](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/sort) сортує масив “на місці”, змінюючи в ньому порядок елементів.
...
Памʼятаєте [стрілкові функції](https://uk.javascript.info/arrow-functions-basics)? Можна використовувати їх тут для того, щоб сортування виглядало більш акуратним:
...
Памʼятаєте алгоритм порівняння [рядків](https://uk.javascript.info/string#correct-comparisons)? Він порівнює літери за їх кодами за замовчуванням.
...
### [reverse](https://uk.javascript.info/array-methods#reverse)

Метод [arr.reverse](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse) змінює порядок елементів в `arr` на зворотний.
...
### [split та join](https://uk.javascript.info/array-methods#split-ta-join)
...
Метод [str.split(delim)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/String/split) саме це і робить. Він розбиває рядок на масив по заданому роздільнику `delim`.
...
Виклик [arr.join(glue)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/join) робить в точності протилежне split. Він створює рядок з елементів `arr`, вставляючи `glue` між ними.
...
### [reduce/reduceRight](https://uk.javascript.info/array-methods#reduce-reduceright)
...
Методи [arr.reduce](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce) та [arr.reduceRight](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/reduceRight) схожі на методи вище, але вони трохи складніші. Вони використовуються для обчислення якогось одного значення на основі всього масиву.
...
Метод [arr.reduceRight](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/reduceRight) працює аналогічно, але проходить по масиву справа наліво.

## [Array.isArray](https://uk.javascript.info/array-methods#array-isarray)
...
…Але масиви використовуються настільки часто, що для цього придумали спеціальний метод: [Array.isArray(value)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/isArray). Він повертає `true`, якщо `value` – це масив, інакше `false`.
...
## [Більшість методів підтримують “thisArg”](https://uk.javascript.info/array-methods#bilshist-metodiv-pidtrimuyut-thisarg)
...
## [Підсумки](https://uk.javascript.info/array-methods#pidsumki)
...
-   [arr.some(fn)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/some)/[arr.every(fn)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/every) перевіряють масив.
...
-   [arr.fill(value, start, end)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/fill) – заповнює масив повторюваними `value`, починаючи з індексу `start` до `end`.
    
-   [arr.copyWithin(target, start, end)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/copyWithin) – копіює свої елементи, починаючи з `start` і закінчуючи `end`, в власну позицію `target` (перезаписує існуючі).
    
-   [arr.flat(depth)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/flat)/[arr.flatMap(fn)](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array/flatMap) – створює новий, плоский масив з багатовимірного масиву.
    

Повний список є в [довіднику MDN](https://developer.mozilla.org/uk/docs/Web/JavaScript/Reference/Global_Objects/Array).
